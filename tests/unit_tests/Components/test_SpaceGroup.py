...
def test_SpaceGroup_as_dict():
    ...
    assert sg_p.to_data_dict() == {'name':                                                             'SpaceGroup',
                                   'space_group_HM_name':                                              {
                                       ...
                                       'display_name': 'hermann_mauguin', 'enabled': True}, 'setting': {
            'name':         'coordinate-code', 'value': 'H', 'units': 'dimensionless',
            'description':  'A qualifier taken from the enumeration list identifying which setting in International Tables for Crystallography Volume A (2002) (IT) is used.',
            'url':          'https://www.iucr.org/__data/iucr/cifdic_html/2/cif_sym.dic/Ispace_group.IT_coordinate_system_code.html',
            'display_name': 'coordinate-code', 'enabled': True}, 'interface':                          None}
...
def test_SpaceGroup_from_dict():
    ...
    assert sg_2.to_data_dict() == sg_p.to_data_dict()
...
def testSpaceGroup_from_SymOps():
    ...
    ops_str = 'x, y, z;-x, y, -z+1/2;-x, -y, -z;x, -y, z+1/2;x+1/2, y+1/2, z;-x+1/2, y+1/2, -z+1/2;-x+1/2, -y+1/2, -z;x+1/2, -y+1/2, z+1/2'
